...
try:
    ...
    print(
        "Please run the script again or manually install the packages.", file=sys.stderr
    )
    sys.exit(1)
...
def record_audio_until_silence(max_duration=60, silence_threshold=3.0):
    ...
    recognizer.non_speaking_duration = (
        0.8  # How long to wait before considering silence
    )
    ...
    print(
        "💡 Natural pauses are okay - the system will wait for you to finish speaking."
    )
            ...
            while True:
                ...
                try:
                    ...
                    if speech_started:
                        ...
                        ):  # Show waiting indicator for longer pauses
